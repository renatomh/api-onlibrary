    ...
    def auth_function(*args, **kwargs):
        ...
        try:
            ...
            if type(res) is not int:
                return jsonify({"data": {},
                                "meta": {"success": False,
                                         "errors": _("Authentication failed. Please login to access the resource.")}}), 401
        ...
        # Otherwise
            ...
            return jsonify({"data": {},
                            "meta": {"success": False,
                                     "errors": (_("Authentication failed. Please login to access the resource."), str(e))}}), 401
    ...
    def auth_function(*args, **kwargs):
        try:
            ...
            # Otherwise we return an error
                ...
                return jsonify({"data": {},
                                "meta": {"success": False,
                                         "errors": _("Authorization failed. Please use an account with the correct access rights.")}}), 403

        # Otherwise
        except Exception as e:
            return jsonify({"data": {},
                            "meta": {"success": False,
                                     "errors": (_("Authorization failed. Please use an account with the correct access rights."), str(e))}}), 403
