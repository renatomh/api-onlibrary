...
if os.environ.get('STORAGE_DRIVER') == 'disk':
    def store_file(file, object_name=None):
        ...
        try:
            ...
            return {'data': {'object_name': object_name,
                             'file_url': f'{os.environ.get("APP_API_URL")}/files/{object_name}'},
                    'meta': {'success': True}}
        except Exception as e:
            print('Error while uploading file:', e)
            return {'success': False, 'errors': f"An error occurred while uploading the file: {e}"}
    ...
    def remove_file(object_name):
        ...
        try:
            ...
            return {'success': False, 'errors': f"An error occurred while removing the file: {e}"}
...
# Amazon AWS S3
    ...
    def store_file(file, object_name=None):
        ...
        try:
            ...
            client.upload_file(file, os.environ.get(
                'AWS_BUCKET'), object_name, ExtraArgs={'ACL': 'public-read', 'ContentType': content_type})
